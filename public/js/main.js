...
var ListItem = require('./ListItem.jsx'); //var ingredients = [{"id":1, "text":"ham"},{"id":2,"text":"cheese"},{"id":3, "text":"potato"}];
...
var ListItem = createReactClass({
  ...
  render: function () {
    return React.createElement("li", null, React.createElement("h4", null, this.props.text));
  }
});
...
var ListManager = createReactClass({
  ...
  render: function () {
    ...
    }), React.createElement("button", null, "Add")), React.createElement(List, {
...
ReactDOM.render(React.createElement(ListManager, {
  title: "Ingredients"
